...
export default function SidebarLeft({}: Props) {
  return (
    <React.Fragment>
      ...
      />
      <aside
        className='fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-900 dark:border-gray-800'
        id='left_drawer_nav'
      >
