...
export default function SidebarLeft({}: Props) {
  return (
    <React.Fragment>
      <input className="hidden w-0 h-0 scale-0 peer/left_drawer_nav" type="checkbox" aria-labelledby="leftDrawerOpenLabel leftDrawerCloseLabel" id="isLeftDrawerActive" />
      <aside className="peer-checked/left_drawer_nav:translate-x-0 fixed top-0 left-0 z-40 h-screen pt-16 transition-transform md:-translate-x-full bg-white border-r border-gray-200 translate-x-0 dark:bg-gray-900 dark:border-gray-800 flex flex-col justify-between">
        <Menu className="flex-1 flex flex-col">
        ...
        <div className="bg-gray-800 flex   flex-row items-center justify-between ">
          ...
          <label className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600" htmlFor="isLeftDrawerActive" id="leftDrawerCloseLabel">
