  ...
  return (
    <React.Fragment>
      <input
        ...
        type='checkbox'
        aria-labelledby='rightDrawerOpenLabel rightDrawerCloseLabel'
        id='isRightDrawerActive'
      />
      <aside
        className='fixed top-0 right-0 z-40 w-64 h-screen pt-14 transition-transform md:translate-x-full bg-white border-r border-gray-200 translate-x-0 dark:bg-gray-900 dark:border-gray-800 target:!translate-x-0'
        id='right_drawer_nav'
      >
