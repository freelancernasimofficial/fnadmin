...
export default function SidebarRight({}: Props) {
  return (
    <React.Fragment>
      <input className="hidden w-0 h-0 invisible" type="checkbox" aria-labelledby="rightDrawerOpenLabel rightDrawerCloseLabel" id="isRightDrawerActive" />
      <aside className="fixed top-0 right-0 z-40 w-64 h-screen pt-14 transition-transform md:translate-x-full bg-white border-r border-gray-200 translate-x-0 dark:bg-gray-900 dark:border-gray-800 target:!translate-x-0" id="right_drawer_nav">
        <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-900">
          ...
          <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-800">
            <li>
        ...
        <div className="absolute bottom-0 left-0 flex justify-start items-end p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-900 z-20">
          <label className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600" htmlFor="isRightDrawerActive" id="rightDrawerCloseLabel">
            <LuPanelRightClose className="w-6 h-6" />
          </label>
