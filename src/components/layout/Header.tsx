      ...
      <div className='flex flex-wrap justify-between items-center'>
        ...
        <div className='flex items-center lg:order-2'>
          ...
          <button
            ...
            className='p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600'
          >
          ...
          {/* Dropdown menu */}
          <div
            className='hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white  divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-800 rounded-xl'
          ...
          <button
            ...
            className='p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600'
          >
            <span className='sr-only'>View notifications</span>
            {/* Icon */}
            <svg
          ...
          {/* Dropdown menu */}
          <div
            className='hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white  divide-y divide-gray-100 shadow-lg dark:bg-gray-800 dark:divide-gray-600 rounded-xl'
            id='apps-dropdown'
          >
            <div className='block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300'>
              Apps
