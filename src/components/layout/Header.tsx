  ...
  return (
    <nav className='bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-900 dark:border-gray-800 fixed left-0 right-0 top-0 z-[50]'>
      <div className='flex flex-wrap justify-between items-center relative'>
        ...
        <button
          type='button'
          className='w-10 h-10 shrink-0 cursor-pointer mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600'
        >
          <VectorButton
        ...
        <input
          ...
          id='isFnNotificationPopUpOpen'
          className='peer/isFnNotificationPopUpOpen shrink-0 w-0 h-0 invisible hidden scale-0'
          type='checkbox'
        />
        <label
        ...
        <button
          type='button'
          className='w-10 shrink-0 h-10 cursor-pointer justify-center items-center text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600'
        >
          <VectorButton
        ...
        {/* Dropdown menu */}
        <input
          aria-labelledby='isFnAppsPopUpCloseLabelButton isFnAppsPopUpOpenLabelButton'
          type='checkbox'
          className='peer/isFnAppsPopUpOpen  w-0 h-0 invisible hidden scale-0'
          id='isFnAppsPopUpOpen'
        />
        <label
        ...
        <button className='mr-2 ml-3 shrink-0  focus:ring-4 ring-gray-600 dark:ring-gray-600 rounded-full'>
          <label
